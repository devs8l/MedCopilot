...
const Patients = () => {
    ...
    return (
        <div className="mx-auto bg-white p-6 py-4  flex flex-col">
            <div className="grid grid-cols-[1fr_2fr_1fr]  px-4 py-4  bg-gray-100 font-semibold text-gray-700 rounded-xl">
                <span>Time</span>
                <span>Patients</span>
            </div>
